...
function MatchTableC({ matches }) {
  ...
  // Filter matches to only include those with grup: 'C'
  const grupBMatches = matches.filter((match) => match.grup === 'C')
