...
function MatchTableD({ matches }) {
  ...
  // Filter matches to only include those with grup: 'D'
  const grupBMatches = matches.filter((match) => match.grup === 'D')
